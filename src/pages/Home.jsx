          ...
          <div className="container">
            <div className="content-box">
              ...
              <div className="content-side">
                <h5 className="content-side__title">Сервисы и услуги</h5>
                <div className="content-side-box">
                  <div className="content-side__list">
                    <div className="content-side__list-item">
                      <img className="content-side__list-item--img" src="/img/truck.svg" alt="truck" />
                    ...
                    <div className="content-side__list-item">
                      <img className="content-side__list-item--img" src="/img/sedan.svg" alt="sedan" />
                    ...
                    <div className="content-side__list-item">
                      <img className="content-side__list-item--img" src="/img/love.svg" alt="love" />
